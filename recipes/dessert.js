...
window.RECIPES.push(
{
  ...
  "notes": [
    "Выход: 4 ватрушки.",
    "КБЖУ указаны примерно на весь рецепт."
  ]
},
{
  "id": "viennese-waffles",
  ...
  "notes": [
    "Ориентир по времени для домашних венских вафель — примерно 20–30 минут с учётом замеса теста и выпекания."
  ]
},
{
  ...
  "ingredients": [
    ...
    {
      "name": "Кукурузные хлопья без сахара",
      "amount": 30,
      "unit": "г"
    }
  ],
  ...
  "notes": [
    "Такой десерт обычно собирается очень быстро — около 10–15 минут."
  ]
},
{
