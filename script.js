      ...
      <article class="basket-dish ${expanded ? "is-open" : ""}">
        ...
        <div class="basket-dish__details" ${expanded ? "" : "hidden"}>
          <div class="basket-dish__details-head">
            ...
            <button type="button" data-copy-recipe-id="${escapeHTML(recipe.id)}" aria-label="Скопировать недостающее для ${escapeHTML(recipe.title)}" title="Скопировать недостающее">${copyIconMarkup()}</button>
          </div>
