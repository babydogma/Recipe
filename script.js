/* Portionly — static app logic, Figma-style dashboard + recipe dropdown cards + cart planning v90 */
(() => {
  "use strict";
  ...
  const CATEGORY_TILE_MEDIA = {
    all: { image: "assets/category-tiles/all-dishes-v090.webp", position: "center 46%" },
    favorites: { image: "assets/category-tiles/favorites-v090.webp", position: "center 48%" },
    breakfast: { image: "assets/category-tiles/breakfast-v090.webp", position: "center 42%" },
    main: { image: "assets/category-tiles/lunch-v090.webp", position: "center 44%" },
    dinner: { image: "assets/category-tiles/dinner-v090.webp", position: "center 40%" },
    dessert: { image: "assets/category-tiles/dessert-v090.webp", position: "center 44%" }
  };
  ...
  function renderCategories() {
    ...
    state.refs.categoryTabs.innerHTML = `
      <div class="dashboard-menu">
        <button class="dashboard-hero-card" type="button" data-dashboard-action="ideas" style="--tile-image: url('assets/category-tiles/lunch-v090.webp'); --tile-image-position: center 45%;">
