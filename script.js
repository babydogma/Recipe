/* Portionly — static app logic, reference redesign v56 */
(() => {
  "use strict";
    ...
    return `
      <section class="basket-dishes" aria-label="Блюда в корзине">
        <header class="basket-section-head">
          ...
          <span class="basket-section-count">${count} ${plural(count, "блюдо", "блюда", "блюд")}</span>
        </header>
  ...
  function dishIngredientRowTemplate(recipeId, item) {
    ...
    return `
      <div class="basket-dish-ingredient ${checked ? "pantry-active" : ""}">
        ...
        <span class="basket-dish-ingredient__name"><b>${escapeHTML(normalized.name)}</b></span>
