/* Portionly — static app logic, ingredient normalization fixes v71 */
(() => {
  "use strict";
  ...
  function getIngredientGroup(name) {
    ...
    if (includesAny(value, ["хлеб", "лаваш", "овся", "булгур", "греч", "манка", "мука", "сухари", "мюсли", "гранола", "чечев", "хлоп", "лапша", "макарон", "спагет", "фунчоза"])) return "grains_bread";
    if (includesAny(value, ["банан", "ягод", "малина", "голубик", "клубник", "мед", "мёд", "сахар", "орех"])) return "fruit_sweet";
    if (includesAny(value, ["огур", "помид", "томат", "зелень", "салат", "карто", "капуст", "морков", "лук", "кабач", "сладкий перец", "болгар", "чеснок", "овощ", "кинз", "брок", "редис", "петруш", "укроп"])) return "vegetables";
