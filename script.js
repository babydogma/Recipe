      ...
      <div class="dashboard-menu">
        ...
        <section class="dashboard-section" aria-label="Планирование и покупки">
          ...
          <div class="dashboard-planning-grid">
            <button class="dashboard-shopping-card" type="button" data-dashboard-action="basket" style="--tile-image: url('assets/dashboard-shopping-bag-v093.webp'); --tile-image-position: 72% center;">
              <span class="dashboard-card__copy">
