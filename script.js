...
(() => {
  ...
  function getIngredientGroup(name) {
    ...
    if (includesAny(value, ["хлеб", "лаваш", "овся", "булгур", "греч", "манка", "мука", "сухари", "мюсли", "гранола", "чечев"])) return "grains_bread";
    if (includesAny(value, ["банан", "ягод", "малина", "голубик", "клубник", "мед", "мёд", "сахар", "орех"])) return "fruit_sweet";
    if (includesAny(value, ["огур", "помид", "томат", "зелень", "салат", "карто", "капуст", "морков", "лук", "кабач", "сладкий перец", "чеснок", "овощ", "кинз"])) return "vegetables";
