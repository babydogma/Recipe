  ...
  function renderBasketModal() {
    ...
    r.basketSummary.innerHTML = `
      <div class="summary-pill summary-pill--accent">
        <small>Выбрано</small><strong>${selectedRecipes.length} ${plural(selectedRecipes.length, "блюдо", "блюда", "блюд")}</strong>
      </div>
      <div class="summary-pill">
        <small>Порций всего</small><strong>${totalPortions}</strong>
      </div>
      <div class="summary-pill">
        <small>Калории</small><strong>${formatNumber(totals.nutrition.kcal)} ккал</strong>
      </div>
      <div class="summary-pill">
        <small>Б / Ж / У</small><strong>${formatNumber(totals.nutrition.protein)} / ${formatNumber(totals.nutrition.fat)} / ${formatNumber(totals.nutrition.carbs)}</strong>
      </div>
    `;
