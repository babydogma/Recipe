/* Portionly — static app logic, Figma-style dashboard + recipe dropdown cards + cart planning v94 */
(() => {
  "use strict";
        ...
        <section class="dashboard-section" aria-label="Планирование и покупки">
          ...
          <div class="dashboard-planning-list">
            <button class="dashboard-planning-row" type="button" data-dashboard-action="basket">
              <span class="dashboard-planning-row__image" aria-hidden="true" style="--row-image: url('assets/dashboard-planning/shopping-v094.webp'); --row-image-position: center 54%;"></span>
            ...
            <button class="dashboard-planning-row" type="button" data-smart-filter="quick">
              <span class="dashboard-planning-row__image" aria-hidden="true" style="--row-image: url('assets/dashboard-planning/quick-v094.webp'); --row-image-position: center 48%;"></span>
              <span class="dashboard-planning-row__copy">
            ...
            <button class="dashboard-planning-row" type="button" data-smart-filter="lowcal">
              <span class="dashboard-planning-row__image" aria-hidden="true" style="--row-image: url('assets/dashboard-planning/lowcal-v094.webp'); --row-image-position: center 52%;"></span>
              <span class="dashboard-planning-row__copy">
