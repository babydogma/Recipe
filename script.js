/* Portionly — static app logic, serving notes + details icon v67 */
(() => {
  "use strict";
  ...
  function getIngredientGroup(name) {
    ...
    if (includesAny(value, ["яй", "молоко", "молоко/вода", "сыр", "творог", "йогурт", "кефир", "сметан"])) return "dairy_eggs";
    if (includesAny(value, ["хлеб", "лаваш", "овся", "булгур", "греч", "манка", "мука", "сухари", "мюсли", "гранола", "чечев", "хлоп"])) return "grains_bread";
    if (includesAny(value, ["банан", "ягод", "малина", "голубик", "клубник", "мед", "мёд", "сахар", "орех"])) return "fruit_sweet";
    if (includesAny(value, ["огур", "помид", "томат", "зелень", "салат", "карто", "капуст", "морков", "лук", "кабач", "сладкий перец", "чеснок", "овощ", "кинз", "брок", "редис", "петруш", "укроп"])) return "vegetables";
    if (includesAny(value, ["масло", "специ", "соль", "перец", "паприка", "лимон", "заправ", "соус", "лавров", "хмели"])) return "oils_spices";
