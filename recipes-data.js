const CATEGORIES = [
  ...
  { id: "main", title: "Обеды / ужины", icon: "🍲" }
];
...
const RECIPES = [
  {
    ...
    category: "breakfast",
    image: "assets/heroes/omelet-cheese-tomato-toast.jpg",
    heroImage: "assets/heroes/omelet-cheese-tomato-toast.jpg",
    portions: 2,
    meta: "на 2 порции",
    ...
    ingredients: [
      ...
      { name: "Масло", amount: 5, unit: "г" },
      { name: "Хлеб для тостов", amount: 80, unit: "г" }
    ],
    steps: ["Взбить яйца с молоком, солью и перцем.", "Помидор нарезать и слегка прогреть на сковороде.", "Влить яйца, добавить сыр и зелень.", "Готовить 5–7 минут и подать с тостами."],
    notes: []
  },
  {
    ...
    category: "breakfast",
    image: "assets/heroes/cottage-cheese-banana-berries-honey.jpg",
    heroImage: "assets/heroes/cottage-cheese-banana-berries-honey.jpg",
    portions: 2,
    meta: "на 2 порции",
  ...
  },
  {
    ...
    category: "breakfast",
    image: "assets/heroes/egg-cheese-tomato-salad-sandwich.jpg",
    heroImage: "assets/heroes/egg-cheese-tomato-salad-sandwich.jpg",
    portions: 2,
    meta: "на 2 порции",
    ...
    ingredients: [
      ...
      { name: "Сыр", amount: 50, unit: "г" },
      { name: "Помидор", amount: 120, unit: "г" },
  ...
  },
  {
    ...
    category: "breakfast",
    image: "assets/heroes/oatmeal-fruits-nuts.jpg",
    heroImage: "assets/heroes/oatmeal-fruits-nuts.jpg",
    portions: 2,
    meta: "на 2 порции",
    nutrition: { kcal: 465, protein: 15, fat: 16, carbs: 66 },
    ingredients: [
      { name: "Овсяные хлопья", amount: 100, unit: "г" },
      { name: "Молоко или вода", amount: 400, unit: "мл" },
      { name: "Банан", amount: 120, unit: "г" },
      { name: "Ягоды", amount: 100, unit: "г" },
      { name: "Орехи", amount: 25, unit: "г" },
      { name: "Мёд", amount: 15, unit: "г" }
    ],
    steps: ["Довести молоко или воду до кипения.", "Добавить овсяные хлопья и варить 5–7 минут.", "Разложить по тарелкам.", "Сверху добавить банан, ягоды, орехи и мёд."],
    notes: []
  },
  {
    ...
    category: "breakfast",
    image: "assets/heroes/lavash-roll-egg-cheese-vegetables.jpg",
    heroImage: "assets/heroes/lavash-roll-egg-cheese-vegetables.jpg",
    portions: 2,
    meta: "на 2 порции",
    ...
    ingredients: [
      ...
      { name: "Огурец", amount: 120, unit: "г" },
      { name: "Помидор", amount: 120, unit: "г" },
      { name: "Листья салата", amount: 20, unit: "г" },
      { name: "Йогурт", amount: 30, unit: "г" }
    ],
  ...
  },
  {
    ...
    category: "breakfast",
    image: "assets/heroes/toast-cottage-cheese-egg-cucumber.jpg",
    heroImage: "assets/heroes/toast-cottage-cheese-egg-cucumber.jpg",
    portions: 2,
    meta: "на 2 порции",
  ...
  },
  {
    ...
    category: "breakfast",
    image: "assets/heroes/mini-cottage-cheese-casserole.jpg",
    heroImage: "assets/heroes/mini-cottage-cheese-casserole.jpg",
    portions: 2,
    meta: "на 2 порции",
    ...
    ingredients: [
      ...
      { name: "Манка или мука", amount: 20, unit: "г" },
  ...
  },
  {
    ...
    category: "breakfast",
    image: "assets/heroes/yogurt-bowl.jpg",
    heroImage: "assets/heroes/yogurt-bowl.jpg",
    portions: 2,
    meta: "на 2 порции",
    ...
    ingredients: [
      ...
      { name: "Банан", amount: 120, unit: "г" },
      { name: "Мюсли или гранола", amount: 70, unit: "г" },
      { name: "Орехи", amount: 20, unit: "г" },
      { name: "Мёд", amount: 10, unit: "г" },
      { name: "Ягоды", amount: 50, unit: "г" }
    ],
    steps: ["Разложить йогурт по мискам.", "Добавить банан.", "Посыпать мюсли, орехами и ягодами.", "Полить мёдом."],
    notes: []
  },
  {
    ...
    category: "breakfast",
    image: "assets/heroes/scramble-bread-vegetables.jpg",
    heroImage: "assets/heroes/scramble-bread-vegetables.jpg",
    portions: 2,
    meta: "на 2 порции",
  ...
  },
  {
    ...
    category: "main",
    image: "assets/heroes/chicken-meatballs-potato-salad.jpg",
    heroImage: "assets/heroes/chicken-meatballs-potato-salad.jpg",
    portions: 6,
    ...
    ingredients: [
      ...
      { name: "Йогурт для заправки", amount: 100, unit: "г" }
    ],
  ...
  },
  {
    ...
    category: "main",
    image: "assets/heroes/pilaf-light-chicken-bulgur.jpg",
    heroImage: "assets/heroes/pilaf-light-chicken-bulgur.jpg",
    portions: 6,
    meta: "на 2 человек на 2–3 дня",
    ...
    ingredients: [
      ...
      { name: "Растительное масло", amount: 35, unit: "г" },
      { name: "Вода", amount: 750, unit: "мл" },
      { name: "Специи для плова", amount: 10, unit: "г" },
      { name: "Соль", amount: null, unit: "по вкусу" },
      { name: "Перец", amount: null, unit: "по вкусу" }
    ],
    steps: ["Курицу нарезать и обжарить до лёгкой корочки.", "Добавить лук и морковь.", "Добавить чеснок и специи.", "Всыпать булгур и залить водой.", "Готовить под крышкой 20 минут и дать настояться."],
  ...
  },
  {
    ...
    category: "main",
    image: "assets/heroes/chicken-lavash-vegetables-yogurt-sauce.jpg",
    heroImage: "assets/heroes/chicken-lavash-vegetables-yogurt-sauce.jpg",
    portions: 6,
    meta: "на 2 человек на 2–3 дня",
  ...
  },
  {
    ...
    category: "main",
    image: "assets/heroes/fish-potato-cauliflower-puree.jpg",
    heroImage: "assets/heroes/fish-potato-cauliflower-puree.jpg",
    portions: 5,
  ...
  },
  {
    ...
    category: "main",
    image: "assets/heroes/beef-vegetables-buckwheat.jpg",
    heroImage: "assets/heroes/beef-vegetables-buckwheat.jpg",
    portions: 6,
    meta: "на 2 человек на 2–3 дня",
