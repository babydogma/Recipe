...
,
  ...
  {
    id: "bulgur-poached-egg-vegetables",
    title: "Булгур с яйцом пашот и овощами",
    category: "breakfast",
    image: "",
    heroImage: "",
    portions: 1,
    meta: "на 1 порцию",
    cookTime: "25–30 мин",
    nutrition: { kcal: 430, protein: 24, fat: 15, carbs: 46 },
    ingredients: [
    ...
    steps: [
      "Булгур промыть и отварить до готовности по инструкции на упаковке.",
      "Помидоры нарезать, шпинат быстро прогреть на сковороде до мягкости.",
      "Для соуса смешать натуральный йогурт, лимонный сок, чеснок, соль и перец.",
      "Приготовить яйцо пашот 3–4 минуты в слабокипящей воде.",
      "Выложить булгур, овощи, яйцо пашот и добавить йогуртовый соус."
    ],
    notes: []
  },
  {
  ...
  },
  {
    ...
    meta: "на 1 порцию",
    cookTime: "15–20 мин",
    nutrition: { kcal: 510, protein: 38, fat: 12, carbs: 57 },
    ingredients: [
      { name: "Паста из твёрдых сортов", amount: 80, unit: "г" },
      { name: "Тунец", amount: 110, unit: "г" },
      { name: "Помидоры", amount: 180, unit: "г" },
      { name: "Чеснок", amount: 4, unit: "г" },
      { name: "Пармезан", amount: 12, unit: "г" },
      { name: "Оливковое масло", amount: 5, unit: "г" },
      { name: "Соль", amount: null, unit: "по вкусу" },
      { name: "Перец", amount: null, unit: "по вкусу" }
    ],
    steps: [
      "Пасту отварить до состояния al dente.",
      "На сковороде прогреть оливковое масло и чеснок.",
      "Добавить нарезанные помидоры и тушить 4–5 минут.",
      "Добавить тунец и пасту, перемешать и прогреть.",
  ...
  },
  {
    ...
    meta: "на 1 порцию",
    cookTime: "20–25 мин",
    nutrition: { kcal: 320, protein: 20, fat: 9, carbs: 39 },
    ingredients: [
      { name: "Бананы", amount: 100, unit: "г" },
      { name: "Яйца", amount: 1, unit: "шт" },
    ...
    steps: [
      "Банан размять вилкой или пробить блендером.",
      "Добавить яйцо, натуральный йогурт, овсяную муку и разрыхлитель.",
      "Перемешать до однородного густого теста.",
      "Выпекать небольшие панкейки на антипригарной сковороде по 1–2 минуты с каждой стороны."
    ],
    notes: []
  },
  {
