window.CATEGORIES = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Болгарский перец", amount: 130, unit: "г" },
      { name: "Огурец", amount: 130, unit: "г" },
      { name: "Морковь", amount: 55, unit: "г" },
      { name: "Репчатый лук", amount: 35, unit: "г" },
...
window.RECIPES = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Перец молотый", amount: null, unit: "по вкусу" },
  ...
  },
  {
    ...
    ingredients: [
      { name: "Куриное филе/грудка", amount: 110, unit: "г" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Яйцо куриное", amount: 45, unit: "г" },
      { name: "Голубика", amount: 120, unit: "г" },
      { name: "Кокосовое масло", amount: 5, unit: "г" },
      { name: "Разрыхлитель", amount: 5, unit: "г" },
      { name: "Фитпарад (сахарозаменитель)", amount: null, unit: "по вкусу" }
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Натуральный йогурт", amount: 85, unit: "г" },
  ...
  },
  {
    ...
    ingredients: [
      { name: "Куриное филе/грудка", amount: 130, unit: "г" },
  ...
  },
  {
    ...
    ingredients: [
      { name: "Вареное яйцо", amount: 70, unit: "г" },
      { name: "Вареный яичный белок", amount: 30, unit: "г" },
